    ...
    <div id="reservation" class="intro-y box px-5 pt-5 pb-5 mt-5">
        <div class="grid grid-cols-12 gap-6">
            ...
            <div
                ...
                <input type="text" name="name" class="input w-full border mt-2" placeholder="Patient Name">
            </div>
            ...
            <div class="col-span-12 sm:col-span-12 md:col-span-6 lg:col-span-4 lg:flex-row pr-3 pl-3 mt-2 -mx-5">
                ...
                <input type="date" class=" input pl-12 border w-full" data-single-mode="true"
                    placeholder="Reservation Date" name="dob">
            </div>
            ...
            <div
                ...
                <input type="tel" name="phone_1" class="input w-full border mt-2" placeholder="Phone Number">
            </div>
            ...
            <div
                ...
                <input type="email" name="email" class="input w-full border mt-2" placeholder="Address">
            </div>
