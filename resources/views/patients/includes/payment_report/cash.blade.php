    ...
    <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
        <div class="report-box text-center">
            <div class="box p-5" style="min-height: 145px;">
                ...
                <div class="text-2xl font-bold leading-8 mt-3">{{ number_format( get_patient_cash($visit->patient) ) }}</div>
            </div>
        </div>
    </div>
    ...
    <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
        <div class="report-box text-center">
            <div class="box p-5" style="min-height: 145px;">
                ...
                <div class="text-2xl font-bold leading-8 mt-3">{{ number_format( get_cash_paid($visit->patient) )  }}</div>
            </div>
        </div>
    </div>
    <!-- END:: PATIENT FINANCIALS DETAILS CARD -->
    ...
    <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
        <div class="report-box text-center">
            <div class="box p-5" style="min-height: 145px;">
                ...
                <div class="text-2xl font-bold leading-8 mt-3">{{ number_format( get_patient_cash_remainig($visit->patient) ) }}</div>
            </div>
        </div>
    </div>
    <!-- END:: PATIENT FINANCIALS DETAILS CARD -->
...
<div class="mt-5">
    ...
    <div class="intro-y box pb-3" style="z-index:1">
        ...
        <div class="overflow-x-auto p-5 hidden lg:block">
            <table class="table">
                ...
                <tbody>
                    ...
                    @foreach ($visit->patient->procedure_payments->where('payment_method','cash') as $index=>$procedure_payment)
                    <tr>
        ...
        @include('includes.tables.payment.cash',['patient' => $visit->patient])
