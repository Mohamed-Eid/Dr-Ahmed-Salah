                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="print border-b dark:border-dark-5 whitespace-no-wrap">
                            ...
                            <button class="button px-2 mr-1 mb-2 bg-theme-3 text-white tooltip" title="report">
                                <a href="{{ route('reports.drug',$drug) }}" class="w-5 h-5 flex items-center justify-center">
