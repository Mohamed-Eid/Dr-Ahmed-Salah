        ...
        <div class="flex sm:flex-row items-center p-5 border-b border-gray-200 dark:border-dark-5">
            ...
            <form class="print grid grid-cols-12 gap-6  mr-auto" id="tabulator-html-filter-form" method="GET" action="{{ route('reports.surgeries') }}">
                ...
                <div class="col-span-8 lg:col-span-6 lg:flex-row py-2 px-5 mt-2 -mx-5">
                    <label class="text-gray-600 mb-3 text-lg">Hospital</label>
        ...
        <div class="overflow-x-auto p-5">
                    ...
                    <tr>
                        ...
                        <td class="border-b dark:border-dark-5">
                            <a href="javascript:;" data-toggle="modal" data-target="#hospital-{{ $hospital->id }}-details"
                                class="button mr-1 mb-2 inline-block bg-theme-1 text-white">Show Hospital Details</a>
                        </td>
                    </tr>
                ...
                <div class="modal__content p-10 text-center" style="width: 90%">
                    ...
                    <form class="flex flex-col lg:grid grid-cols-12 gap-6 mt-5 intro-y box px-5 pt-5 pb-5 mt-5" method="POST" action="{{ route('hospitals.store') }}"> 
                        ...
                        <div class="col-span-12 lg:flex-row pr-3 pl-3 -mx-5">
                            ...
                            <input type="text" name="name" class="input w-full border mt-2" placeholder="Revealed Cost">
                        </div>
            ...
            <div class="modal" id="hospital-{{ $hospital->id }}-details">
                <div class="modal__content p-10 text-center" style="width: 95%">
                    ...
                    <div class="intro-y flex items-center pt-5 h-10">
                        <h2 class="text-lg font-medium text-gray-600 truncate mr-5">Hospital : {{ $hospital->name }} Report</h2>
                    </div>
                                ...
                                <div class="col-span-12 sm:col-span-6 xl:col-span-4 intro-y text-center">
                                    <div class="report-box ">
                                        <div class="box p-5 bg-blue-400">
                                            <div class="text-base text-white mt-1"> Total Patient Fees </div>
                                ...
                                <div class="col-span-12 sm:col-span-6 xl:col-span-4 intro-y text-center">
                                    <div class="report-box ">
                                        <div class="box p-5 bg-red-400">
                                            <div class="text-base text-white mt-1"> Total Hospital Fees </div>
                                ...
                                <div class="col-span-12 sm:col-span-6 xl:col-span-4 intro-y text-center">
                                    <div class="report-box ">
                                        <div class="box p-5 bg-green-400">
                                            <div class="text-base text-white mt-1"> Total Doctor Profits </div>
                        ...
                        <div class="intro-y box pb-3" style="z-index:1">
                            <div class="flex sm:flex-row items-center p-5 border-b border-gray-200 dark:border-dark-5">
                                ...
                                <div class="grid grid-cols-12 gap-6">
                                    <form class="print flex mr-auto col-span-12 md:col-span-6"
                                        id="tabulator-html-filter-form">

                                        <div
                                            class="sm:flex-row items-center col-span-12 sm:col-span-12 md:col-span-6 lg:col-span-4 mt-2">
                                            <label class="text-gray-600 mb-3 text-lg">Sarch For</label>
                                            <input type="text" class="input w-full border" placeholder="Search">
                                        </div>

                                        <div
                                            class="sm:flex-row items-center col-span-12 sm:col-span-12 md:col-span-6 lg:col-span-2 mt-1">
                                            <button type="button"
                                                class="button text-center w-11 h-11 bg-theme-1 text-white mx-2 mt-8"
                                                id="">
                                                <i data-feather="search" class="w-5 h-5 text-center"></i>
                                            </button>
                                        </div>
                                ...
                                <table class="table" id="table-{{ $hospital->id }}">
                                    <thead>
                                        <tr class="bg-gray-200 dark:bg-dark-1">
                                            ...
                                            <th class="border-b-2 dark:border-dark-5 whitespace-no-wrap">Total Patient
                                                Fees</th>
                                            <th class="border-b-2 dark:border-dark-5 whitespace-no-wrap">Total Hospital
                                                Fees</th>
                                            <th class="border-b-2 dark:border-dark-5 whitespace-no-wrap">Total Doctor
                                                Profits</th>
                                        </tr>
                                    </thead>
